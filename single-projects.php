	...
	<section class="org--hero-project ut--block-margin" style="background-color:<?php the_field('hp_background_color');?>">
		<div class="container">
			<div class="row g-0">
				<div class="col-12">
					<figure>
						<img class="mw-100" src="<?php the_field('hp_image_file');?>">
									...
									<div class="row g-0">
										...
										<div class="col-12 col-md-4">
											<div class="atm--specifics-project ut-end-sp text-center text-md-start h-100">
												<h4>Material</h4>
												<span><?php the_sub_field('md_material'); ?>STUFF STUFF STUFF STUFF</span>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row g-0 d-flex">
							<div class="col-12 col-md-6">
								<div class="d-flex justify-content-center justify-content-lg-start">
									<figure>
										<img class="mw-100" <?php if(get_sub_field('halfp_imglft_mw')) { ?>style="max-width:<?php the_sub_field('halfp_imglft_mw'); ?>px;"<?php } ?> src="<?php the_sub_field('halfp_image_left'); ?>">
							...
							<div class="col-12 col-md-6">
								<div class="d-flex justify-content-center justify-content-lg-start">
									<figure class="rotate-figcaption">
										<img class="mw-100" <?php if(get_sub_field('halfp_imgrgt_mw')) { ?>style="max-width:<?php the_sub_field('halfp_imgrgt_mw'); ?>px;"<?php } ?> src="<?php the_sub_field('halfp_image_right'); ?>">
