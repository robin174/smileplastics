			...
			<div class="row g-0 d-flex">
				<div class="col-12 col-lg-6 align-self-center">
					...
					<div class="d-flex justify-content-end"><!-- set this for each block, in case image not square -->
						<figure>
							<img class="mw-100" src="<?php the_field('hm_image_file');?>">
								<?php if( get_field('hm_image_caption_pos') == 'overlaylight' && get_field('hm_image_caption_pos_lr') == 'captionleft' ) { ?>
									<figcaption class="atm--fc-overlaylight atm--fc-left"><i class="far fa-long-arrow-up"></i><?php the_field('hm_image_caption'); ?>cc</figcaption>
					...
					<div class="row g-0 d-flex">
						<div class="col-12 col-md-6">
							<div class="d-flex justify-content-center justify-content-lg-start">
								<figure>
									<img class="mw-100" <?php if(get_sub_field('halfm_imglft_mw')) { ?>style="width:<?php the_sub_field('halfm_imglft_mw'); ?>px;"<?php } ?> src="<?php the_sub_field('halfm_image_left'); ?>">
						...
						<div class="col-12 col-md-6">
							<div class="d-flex justify-content-center justify-content-lg-start">
								<figure class="rotate-figcaption">
									<img class="mw-100" <?php if(get_sub_field('halfm_imgrgt_mw')) { ?>style="width:<?php the_sub_field('halfm_imgrgt_mw'); ?>px;"<?php } ?> src="<?php the_sub_field('halfm_image_right'); ?>">
