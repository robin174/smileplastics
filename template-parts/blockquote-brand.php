<section class="org--blockquote-brand">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12 col-md-9 col-lg-6">
					...
					<h3 class="text-center">Collaboration for a brighter future</h3>
				</div>
			</div>
			<div class="row justify-content-center">
	...
	<!-- colour could be bought in if the below cycles the 'projects' CPT -->
	<!-- This is a Slider potential:
	Slick: https://kenwheeler.github.io/slick/
	Manual: https://codepen.io/velvet-cerise/pen/bGNjrxV -->
